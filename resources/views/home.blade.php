                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('product') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="product_code" placeholder="AB001" />
                                    @error('product_code')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="unit_price" placeholder="0.00"></input>
                                    @error('unit_price')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
